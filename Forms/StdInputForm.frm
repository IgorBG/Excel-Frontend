...
Begin {C62A69F0-16DC-11CE-9E98-00AA00574A4F} StdInputForm 
   Caption         =   "Âúâåæäàíå â áàçà äàííè"
   ClientHeight    =   5490
   ClientLeft      =   45
   ClientTop       =   330
   ClientWidth     =   5715
...
Private Const defWindowCaption As String = "Ïðîçîðåö çà âúâåæäàíå"
Private Const defHelpCaption As String = "Âúâåäåòå äàííèòå, êîèòî æåëàåòå äà âúåäåòå â Áàçàòà äàííè"
